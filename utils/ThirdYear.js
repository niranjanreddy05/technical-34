...
print(D)
		`,
		answerOptions: [
			{ answerID: 'a', answerText: "{0: 1, 7: 0, 1: 1, 8: 1}" },
...
print(len(mylist))
	...
	},
	{
		...
		code:
			`nums = [1, 2, 3, 4, 5]
result = [x*y for x in nums for y in range(x) if y % 2 == 0]
print(result)`,
		answerOptions: [
			{ answerID: 'a', answerText: '[0, 0, 2, 0, 2, 4, 0, 2, 4, 6]' },
			{ answerID: 'b', answerText: '[0, 0, 3, 0, 3, 6, 0, 3, 6, 9]' },
			{ answerID: 'c', answerText: '[1, 4, 9, 16, 25]' },
			{ answerID: 'd', answerText: '[0, 0, 2, 0, 2, 6, 0, 2, 6, 10]' }
		],
		correctResponse: 'a'
	},
	{
...
tup[:-2]`,
	...
	{
		id: 37,
		questionText: "What will be the output of the following program?",
		code:
			`public class Test {
    public static void main(String[] args) {
		...
		answerOptions: [
			{ answerID: 'a', answerText: '50 5 10' },
			{ answerID: 'b', answerText: '45 6 9' },
			{ answerID: 'c', answerText: '50 6 9' },
			{ answerID: 'd', answerText: '45 5 10' }
		],
		correctResponse: 'c'
	},
	{
